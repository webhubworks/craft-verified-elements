...
hero:
  name: Verified Elements
  text: für Craft CMS
  tagline: Erfahren Sie, wie Sie das Craft-Plugin Verified Elements für Ihre CMS-Inhalte einsetzen.
  image:
    src: /logo.svg
    alt: Verified Elements
  actions:
    - theme: brand
      text: Erste Schritte
...
features:
  - title: Einträge und Dateien
    details: Verifizieren Sie Einträge und Dateien mit demselben Workflow.
  - title: Unterstützung für mehrere Websites
    details: Verfolgen Sie die Verifizierung pro Website, mit Website-bezogenen Dashboards, Widgets und Benachrichtigungen.
  - title: Automatische Prüfer-Benachrichtigungen
...
4. [Der Verifizierungs-Bereich](verified-elements-section.md). Der eigene Control-Panel-Bereich des Plugins zum Suchen und Filtern nach Verifizierungsstatus.
...
8. [E-Mail-Benachrichtigungen](email-notifications.md). Ablauf-Zusammenfassungen und Änderungshinweise.
9. [Einstellungen](settings.md). Bereiche und Volumes aktivieren, Standard-Prüfer und Gültigkeitsdauern festlegen.
10. [Berechtigungen und Editionen](permissions-and-editions.md). Wer was darf und was die einzelnen Pläne enthalten.
11. [FAQ und Problemlösungen](faq.md). Antworten auf häufige Fragen.
