...
## Verifiziert bis
Das Datum, bis zu dem ein Inhalt als korrekt gilt. Sie setzen es, indem Sie eine Gültigkeitsdauer wählen (7 Tage, 30 Tage, 90 Tage, 1 Jahr), ein bestimmtes Datum auswählen oder **Unbegrenzt** wählen. Standardmäßig ist das Datum auf **Unbegrenzt** gesetzt.


## Verifizierungsstatus
Jedes verfolgte Element befindet sich in einem von zwei Zuständen:

- **Verifiziert** (grün). Das "Verifiziert bis"-Datum liegt in der Zukunft, oder das Element ist unbegrenzt verifiziert.
- **Abgelaufen** (rot). Das "Verifiziert bis"-Datum ist überschritten. Das Element muss überprüft werden.

::: note
Der Status erscheint nur im Control Panel: auf den Bearbeitungsseiten von Einträgen und Dateien, in den Spalten einer Element-Listenseite, im eigenen Bereich des Plugins (zu finden in Crafts Hauptnavigation) und in Dashboard-Widgets.
:::
