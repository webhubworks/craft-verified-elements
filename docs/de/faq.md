...
## Ich sehe den Plugin-CP-Bereich nicht in der Navigation
...
Es ist kein Ablaufdatum gesetzt. Das Element gilt als Verifiziert und läuft nie ab. Auch Elemente in aktivierten Bereichen, die nie ausdrücklich verifiziert wurden, erscheinen als Unbegrenzt, und beides lässt sich derzeit nicht unterscheiden — die Standard Gültigkeitsdauer eines Bereichs kann selbst auf "Unbegrenzt" konfiguriert sein, wodurch das erste Speichern genauso wirkt, als hätte jemand es von Hand gewählt.
...
- Fehlerberichte: [Ein Issue erstellen](https://github.com/webhubworks/craft-verified-elements/issues) auf GitHub.
- Support für Anwender: <support@webhub.de>.
