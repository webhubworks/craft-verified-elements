...
When someone assigns you as the Reviewer of an entry or asset, you become responsible for re-checking it:

- When its "Verified until" date passes, you receive an **email digest** listing everything of yours that expired.
- When the element is changed while it is verified, you receive a **change alert email** so you can re-check the edits.
- The element appears in your personal review queue (see below) until it is verified again.

## Where to find your review queue

You have three views of the same queue:
