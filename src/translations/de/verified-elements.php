...
return [
    ...
    'Asset verification' => 'Verifizierung von Dateien',
    'Assign Reviewer' => 'Prüfer zuweisen',
    'Assigned' => 'Zugewiesen',
    'Bulk verification actions' => 'Massenaktionen zur Verifizierung',
    'Change' => 'Ändern',
    ...
    'Entry verification' => 'Verifizierung von Einträgen',
    'Expired' => 'Abgelaufen',
    'Expiry email notifications' => 'E-Mail-Benachrichtigungen bei Ablauf',
    'Found in' => 'Zu finden in',
    'Has Date' => 'Hat Datum',
    'Ideal for individuals keeping a single site fresh.' => 'Ideal für Einzelpersonen, die eine einzelne Website aktuell halten.',
    'Ideal for organizations verifying entries and assets at scale.' => 'Ideal für Organisationen, die Einträge und Dateien in großem Umfang verifizieren.',
    'Ideal for teams managing content across multiple sites.' => 'Ideal für Teams, die Inhalte über mehrere Websites hinweg verwalten.',
    'Imminent' => 'Bevorstehend',
    'Indefinite' => 'Unbegrenzt',
    'Manage Verification Settings' => 'Verifizierungseinstellungen verwalten',
    'Multi-site support' => 'Unterstützung für mehrere Websites',
    ...
    'Verification periods per section' => 'Gültigkeitsdauer pro Bereich',
